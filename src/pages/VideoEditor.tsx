...
export function VideoEditor() {
  ...
  // Storyboard-Grid projects open a result MODAL over the dashboard (see
  // ResultModal + Dashboard route /studio/projects/:id/result). If somehow a
  // grid project lands on the legacy editor route, redirect cleanly.
  if (useGrid) {
    nav(`/studio/projects/${id}/result`, { replace: true })
    return null
  }
